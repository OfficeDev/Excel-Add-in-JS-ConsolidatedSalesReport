        ...
        Excel.run(function (ctx) {
            ...
            return ctx.sync()
                .then(function () {
                    ...
                    // Queue commands to load the values and address of each selected sheet's used range
                    // Store it an array
                    selectedSheetNamesArray.forEach(function (item) {
                        var usedRange = sheets.getItem(item).getUsedRange()
                ...
                .then(function () {
                    ...
                    var firstUsedRange = usedRanges[0];
